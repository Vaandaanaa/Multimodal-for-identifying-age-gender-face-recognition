...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(r'C:\Python37\Major\haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
    faces=face_haar.detectMultiScale(gray_img,scaleFactor=1.3,minNeighbors=5)
